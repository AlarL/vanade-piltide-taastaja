              ...
              <div className="absolute right-0 mt-1.5 w-64 rounded-xl bg-white border border-stone-200 shadow-lg py-1.5 z-40">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-stone-500">Täisresolutsioonis terav foto</p>
                  </div>
                </button>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-stone-500">Kõrvuti originaal ja uus foto</p>
                  </div>
                </button>
              </div>
            )}
            ...
            >
              ...
              >
                ...
                <div className="absolute top-3 left-3 pointer-events-none">
                  <span className="px-2.5 py-1 text-[11px] font-medium tracking-wide uppercase bg-stone-900/70 text-white rounded-md backdrop-blur-xs shadow-xs">
                    Enne (Originaal)
                  </span>
                </div>
                <div className="absolute top-3 right-3 pointer-events-none">
                  <span className="px-2.5 py-1 text-[11px] font-medium tracking-wide uppercase bg-emerald-950/80 text-emerald-100 rounded-md backdrop-blur-xs shadow-xs flex items-center gap-1">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="flex flex-col items-center space-y-2">
              <div className="flex items-center justify-between w-full px-1">
                ...
                <span className="text-[11px] text-stone-400">Mustvalge / kahjustatud</span>
              </div>
